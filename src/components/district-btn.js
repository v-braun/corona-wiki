...
*/
export class DistrictButton extends Component{

  static propTypes = {
    ags: PropTypes.string.isRequired,
  ...
  render(){
    ...
    return (
      <button ref={this.btnRef} id={this.props.ags} className={classes} type="button" onClick={() => this.props.onClick(this.props.ags, this.btnRef)}>
